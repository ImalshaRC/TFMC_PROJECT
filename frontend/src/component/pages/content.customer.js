      ...
      <Menu id="simple-menu" anchorEl={anchorEl} keepMounted open={Boolean(anchorEl)} onClose={handleClose}>
          ...
          <MenuItem onClick={handleClose}>
              <button className="tableMenuBtn" onClick={() => props.changeClickOpen(props.customer._id)}>
                <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-person-check" viewBox="0 0 16 16">
                  <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                  <path fillRule="evenodd" d="M15.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L12.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
                </svg>
                <span>Mark Corporate</span>
              </button>
          </MenuItem>
          <MenuItem onClick={handleClose}>
...
class CustomerTable extends Component {
    ...
    componentDidMount() {
      axios.get('http://localhost:5000/customer/customers')
        .then(response => {
    ...
    handleTextSearch=(e)=>{
      ...
      axios.get("http://localhost:5000/customer/customers").then(res=>{
        if(res.data){
          ...
          <div>
            <div className="searchPanel">
              <div className="searchPanel_addNew">
                  <button className="newCustomer_btn" onClick={() => this.nextPath('/CreateCustomer')}>
            ...
            <Dialog open={this.state.removeClick} onClose={this.removeClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  ...
                  (It lost this customer Order Details)
                </DialogContentText>
              </DialogContent>
              <DialogActions>
