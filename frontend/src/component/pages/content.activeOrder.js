    ...
    <tr>
      ...
      <Menu id="simple-menu" anchorEl={anchorEl} keepMounted open={Boolean(anchorEl)} onClose={handleClose}>
          ...
          <MenuItem onClick={handleClose}>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-person-lines-fill" viewBox="0 0 16 16">
...
class ActiveOrderTable extends Component {
    constructor(props) {
      super(props);
    ...
    handleTextSearch=(e)=>{
       ...
       axios.get("http://localhost:5000/order/active").then(res=>{
         if(res.data){
...
export default withRouter(ActiveOrderTable);